        ...
        <>
            ...
            <div id="dropMenuBar">
                ...
                <div  className={`flex flex-col w-screen sticky top-0 ${styleToggle.bgCol} `} style={styleToggle}>
                    <a href="/" className={`py-4 my-1 mx-auto cursor-pointer ${styleToggle.col} hover:underline `}>Home</a>
                    <a href="/About" className={`py-4 my-1 mx-auto cursor-pointer ${styleToggle.col} hover:underline `}>About Us</a>
                    <a href="/Contact" className={`py-4 my-1 mx-auto cursor-pointer ${styleToggle.col} hover:underline `}>Contact Us</a>
                    <a href="/Services" className={`py-4 my-1 mx-auto cursor-pointer ${styleToggle.col} hover:underline `}>Services</a>
                </div>
            </div>
