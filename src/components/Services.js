      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto">Hi there, These are some of my services which I can provide you.</p>
          </div>
          ...
          <a href="/Contact"><button className="flex mx-auto mt-16 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Join Us?</button></a>
        </div>
      </section>
    </>
  )
